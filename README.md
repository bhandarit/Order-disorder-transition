...
The repository includes all code required to:
...
Topology and configuration files
...
Contents
Analysis scripts for extracting quantitative observables
Plotting scripts for reproducing figures
